...
{
	Comet comet = null;
	Vector<Planet> planets = new Vector<Planet>();//reccomended change from eclipse
	...
	public void update()
	{
		...
		if(planets!= null)
		{
			...
			if(isMousePressed(1))
			{
				...
				{
					comet.xVelocity = (comet.x-mouseX)/10.0;
					comet.yVelocity = (comet.y-mouseY)/10.0;
				}
			}
			if(isMousePressed(3))
			{
			...
			if(isKeyPressed("L"))
			{
				...
				{
					resetKeys();
					//Scanner kb = new Scanner(System.in); kb is never used bad coding
